<?php
    ...
    if(isset($_POST['themsanpham'])){
        ...
        if(!empty($_FILES['hinhanh']['name'])){
            ...
            $sql_update = "UPDATE tbl_sanpham SET tensanpham='".$tensanpham."', masp='".$masp."', giasp='".$giasp."', soluong='".$soluong."', tomtat='".$tomtat."', noidung='".$noidung."', tinhtrang='".$tinhtrang."', id_danhmuc='".$danhmuc."' 
            WHERE id_sanpham = '$_GET[idsanpham]'";
        }
        ...
        header('Location:../../index.php?action=quanlysp&query=them');
    }elseif(isset($_GET['idyeuthich'])){
        $id = $_GET['idyeuthich'];
        $sql_xoa = "DELETE FROM tbl_yeuthich WHERE product_id = '".$id."'";
        mysqli_query($mysqli, $sql_xoa);
