<?php
    ...
    if(isset($_GET['code'])){
        ...
        if(mysqli_num_rows($query_thongke)==0){
            ...
            $doanhthu = $doanhthu;
            $donhang =1;
            $sql_update_thongke = mysqli_query($mysqli, "INSERT INTO tbl_thongke (ngaydat, soluongban, doanhthu, donhang) VALUE ('$now',
            '$soluongban','$doanhthu','$donhang')");
            ...
            while($row_tk = mysqli_fetch_array($query_thongke)){
                ...
                $sql_update_thongke = mysqli_query($mysqli,"UPDATE tbl_thongke SET soluongban='$soluongban',doanhthu='$doanhthu',donhang='$donhang' 
                WHERE ngaydat = '$now'");
            }
        }
