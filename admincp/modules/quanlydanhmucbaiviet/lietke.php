...
<table border=1 style="border-collapse:collapse;" width="100%">
  ...
  <tr>
    ...
    <td>
      <a href="modules/quanlydanhmucbaiviet/xuly.php?idbaiviet=<?php echo $row['id_baiviet'] ?>" class="btn btn-danger">Xóa</a>
      <a href="?action=quanlydanhmucbaiviet&query=sua&idbaiviet=<?php echo $row['id_baiviet']?>" class="btn btn-primary">Sửa</a>
    </td>
