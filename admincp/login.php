    ...
    <div class="wrapper-login">
        <form action="" autocomplete="off" method="POST">
            <table border="1" class="table-login" style="text-align: center; border-collapse: collapse">
                ...
                <tr>
                    <td colspan="2"><input type="submit" value="Đăng nhập" name="dangnhap"></td>
                </tr>
            </table>
        </form>
    </div>
...
<?php
    ...
    if(isset($_POST['dangnhap'])){
        ...
        if($count>0){
            ...
            echo '<scripts>alert("Thông tin tài khoản hoặc mật khẩu không chính xác! Vui lòng đăng nhập lại")</scripts>';
    ...
    <div ng-app ng-init="checked = false">
        <form class="form-signin" action="" method="POST" autocomplete="off">
          ...
          <div class="btn-animate">
            <input type="submit" value="Đăng nhập" name="dangnhap"></td>
          </div>
        </form>
