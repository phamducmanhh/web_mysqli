<?php
    ...
    if(isset($_GET['vnp_Amount'])){
        ...
        if($cart_query){
            ...
            echo "<p>Vui lòng vào trang <a target='_blank' href='quanly=lichsudonhang'>Lịch sử đơn hàng</a> để xem chi tiết đơn hàng</p>";
        }else{
...
?>
<p>Cảm ơn bạn đã mua hàng, Chúng tôi sẽ cố gắn liên hệ với bạn trong thời gian sớm nhất</p>