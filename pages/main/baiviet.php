...
?>
<h2>BÀI VIẾT: <span style="text-align:center; text-transform: uppercase"><?php echo $row_bv_title['tenbaiviet'] ?></span></h2>
                <ul class="product_list_bv">
                    <?php
                    ...
                    <li>
                        ...
                        <p class="title_product_bv"> <?php echo $row_bv['tomtat'] ?></p>                       
                        
                        <p class="title_tomtat_bv" style="margin:10px"> <?php echo $row_bv['noidung'] ?></p>
                    </li>
                    <?php
                        }
                    ?>
