...
<nav class="navbar navbar-expand-lg navbar-light bg-light" style="width:100%">
  <a name="trangchu" class="navbar-brand" href="index.php"><i class="fa-solid fa-house"></i> Trang chủ</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a style="color: black; font-weight: 400; font-size: 1.1rem;" class="nav-link" href="index.php?quanly=giohang"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Giỏ hảng</a>
      </li>
      <li class="nav-item">
        <a style="color: black; font-weight: 400; font-size: 1.1rem;"class="nav-link" href="index.php?quanly=yeuthich"><i class="fa fa-heart" aria-hidden="true"></i> Yêu thích</a>
      </li>
      <li class="nav-item">
        <a style="color: black; font-weight: 400; font-size: 1.1rem;" class="nav-link" href="index.php?quanly=tintuc"><i class="fa-solid fa-earth-americas"></i> Tin tức</a>
      </li>
      <li class="nav-item">
        <a style="color: black; font-weight: 400; font-size: 1.1rem;" class="nav-link" href="index.php?quanly=lienhe"><i class="fa fa-phone" aria-hidden="true"></i> Liên hệ</a>
      </li>
      <!-- <li class="nav-item dropdown">
        ...
        <?php
                ...
                <li class="nav-item"><a class="nav-link" href="doimatkhau.php">Đổi mật khẩu</a></li>
